...
<?php } elseif(is_search()) { // Search results header ?>
	<div class="archive">
		...
		<div class="content">
			<p><?php _e('Your search for ', 'tarski'); echo '<strong>' . $s . '</strong> '; _e('returned the following results.', 'tarski'); ?></p>
		</div>
	</div>
...
<div class="primary">
	<div class="entry">
		...
		<div class="content">
			<p><?php echo __('Your search for ', 'tarski') . '<strong>' . $s . '</strong>' . __(' returned no results. Try returning to the ', 'tarski') . '<a href="' . get_settings('home') . '">' . __('front page', 'tarski') . '</a>' . __('.', 'tarski'); ?></p>
		</div>
	</div>
</div>
